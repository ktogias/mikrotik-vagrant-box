...
# Modified copy of https://github.com/vagrant-libvirt/vagrant-libvirt/blob/main/tools/create_box.sh
# Added libvirt.disk_bus = "sata" on line 121. RouterOS will not boot from an virtIO disk.
